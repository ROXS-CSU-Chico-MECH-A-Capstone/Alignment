...
Int1n=GetIntensity(x1n,y1n,xo,yo);
...
while Linear1M(a,3)>=.99999*mean([Linear1M(a-1,3) Linear1M(a-2,3) Linear1M(a-3,3)]) %continue if current value is above threshold
a=a+1;
...
hold on
plot3(x,y,Intensity,'r.')
plot3(Linear1M(:,1),Linear1M(:,2),Linear1M(:,3),'b+')

[pksL1, locsL1]=findpeaks(Linear1M(:,3));
Spiral2=[Linear1M(locsL1,1),Linear1M(locsL1,2)];